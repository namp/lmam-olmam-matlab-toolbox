function [w1,b1,w2,b2,i,tr] = tolmam2(w1,b1,f1,w2,b2,f2,p,t,tp)
% TOLMAM2 Train a feed-forward network with one hidden layer 
% with the Optimized Levenberg-Marquardt with Adaptive Momentum algorithm (OLMAM).
%
%       [W1,B1,W2,B2,TE,TR] = TOLMAM2(W1,B1,'F1',W2,B2,'F2',P,T)
