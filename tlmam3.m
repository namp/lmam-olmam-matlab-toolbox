function [w1,b1,w2,b2,w3,b3,i,tr] = tlmam3(w1,b1,f1,w2,b2,f2,w3,b3,f3,p,t,tp)
% TLMAM3 Train a feed-forward network with two hidden layers 
% with the Levenberg-Marquardt with Adaptive Momentum algorithm (LMAM).
%
%         [W1,B1,W2,B2,W3,B3,TE,TR] = TLMAM3(W1,B1,F1,W2,B2,F2,W3,B3,F3,P,T)
