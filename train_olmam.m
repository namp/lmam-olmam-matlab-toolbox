function [a,b,c,d,e,f,g,h] = train_olmam(i,j,k,l,m,n,o,p,q,r,s,t)
%TRAIN_OLMAM Train feed-forward network with with 0, 1 or 2 hidden layers 
%with the Optimized Levenberg Marquardt with Adaptive Momentum (OLMAM) algorithm.
...
%
%Calling sequence:	
%	[W1,B1,W2,B2,...,TE,TR] = TRAIN_OLMAM(W1,B1,F1,W2,B2,F2,...,P,T,TP)
...
if nargin == 5
  [a,b,c,d] = tolmam1(i,j,k,l,m);
elseif nargin == 6
  [a,b,c,d] = tolmam1(i,j,k,l,m,n);
elseif nargin == 8
  [a,b,c,d,e,f] = tolmam2(i,j,k,l,m,n,o,p);
elseif nargin == 9
  [a,b,c,d,e,f] = tolmam2(i,j,k,l,m,n,o,p,q);
elseif nargin == 11
  [a,b,c,d,e,f,g,h] = tolmam3(i,j,k,l,m,n,o,p,q,r,s);
elseif nargin == 12
  [a,b,c,d,e,f,g,h] = tolmam3(i,j,k,l,m,n,o,p,q,r,s,t);
end
