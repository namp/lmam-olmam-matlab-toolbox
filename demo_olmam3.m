%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DEMO_OLMAM3 Optimized Levenberg-Marquardt with Adaptive Momentum (OLMAM).
...
[w1,b1,w2,b2,w3,b3,ep,tr] = train_olmam(w1,b1,'logsig',w2,b2,'logsig',w3,b3,'logsig',P,T,tp);
